#!/usr/bin/env python3
"""
Script to process i2g2ro_assets videos and create a combined GIF
"""
...
def main():
    ...
    combined_gif = output_dir / "i2g2ro_combined.gif"
    ...
    print("Processing i2g2ro_assets videos...")
    ...
    cmd6 = [
        ...
        '-t', '15',  # Limit to 15 seconds total
        str(combined_gif)
    ]
